...
The **numpy.percentile()** function is useful to determine the *n^th^-percentile* for the given array of data. It returns an array with percentile values or scalar along the specified axis. The function accepts the following parameters:
